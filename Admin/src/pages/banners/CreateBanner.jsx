...
const CreateBanner = ({ onClose }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    type: "featured", // Correct key for backend
    status: "draft",
    startDate: "",
    endDate: "",
    tags: [],
  ...
  const handleImageUpload = (e) => {
    ...
    setBannerImages([...bannerImages, ...previewUrls]);
  };

  const removeImage = (index) => {
    const newPreview = [...bannerImages];
    const newFiles = [...imageFiles];
    newPreview.splice(index, 1);
    newFiles.splice(index, 1);
    setBannerImages(newPreview);
    setImageFiles(newFiles);
    if (currentImageIndex >= newPreview.length) {
      setCurrentImageIndex(Math.max(0, newPreview.length - 1));
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ form: "Failed to create banner. Try again." });
    }
  };
      ...
      <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500"
                >
                  {["featured", "new-arrival", "trending", "sale", "festival"].map((type) => (
        ...
        <div className="pt-5 flex justify-end space-x-3">
          ...
          <button
            ...
            className="px-4 py-2 border border-transparent rounded-md text-sm text-white bg-pink-600 hover:bg-pink-700"
          >
            Create Banner
          </button>
        </div>
