...
import { FiMenu, FiShoppingCart, FiHeart, FiUser, FiSearch, FiChevronDown } from 'react-icons/fi';
...
const Navbar = () => {
  ...
  const [isAuthenticated, setIsAuthenticated] = useState(false); // TODO: Get from AuthContext
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
                      ...
                      <Menu.Item key={item.name}>
                        {({ active }) => (
                          <Link
                            to={item.href}
                            className={`${
                              active ? 'bg-gray-100 text-pink-600' : 'text-gray-700'
            ...
            <Link to="/collections/new-arrivals" className="text-gray-700 hover:text-pink-600">
              New Arrivals
            </Link>
          </div>
        ...
        {() => (
          <div className="md:hidden bg-white/95 backdrop-blur-sm border-t">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              {/* Navigation Links */}
              <Link to="/shop" className="block px-3 py-2 text-gray-700 hover:text-pink-600 rounded-md hover:bg-pink-50 transition duration-200">
                Shop
              </Link>
              {collections.map((item) => (
                <Link
              ...
              <Link to="/new-arrivals" className="block px-3 py-2 text-gray-700 hover:text-pink-600 rounded-md hover:bg-pink-50 transition duration-200">
                New Arrivals
              </Link>
              {!isAuthenticated && (
